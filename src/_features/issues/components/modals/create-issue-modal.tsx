    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        {trigger || (
          <Button 
            size="sm"
            className="gap-1 md:gap-2 bg-[#0052CC] hover:bg-[#0065FF] text-white text-xs md:text-sm px-2 md:px-3 h-8 md:h-9"
          >
            <Plus className="h-3.5 w-3.5 md:h-4 md:w-4" />
            <span className="hidden sm:inline">이슈 만들기</span>
            <span className="sm:hidden">이슈</span>
          </Button>
        )}
      </DialogTrigger>
